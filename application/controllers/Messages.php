...
class Messages extends Secure_area implements iData_controller {
    ...
    function _dt_inbox()
    {
        ...
        foreach ($messages->result() as $message)
        {
            ...
            $data_row["date"] = date($this->config->item("date_format") . " H:iA", strtotime($message->send_date));
    ...
    function save($message_id = -1)
    {
        ...
        {
            //New Messages
            echo json_encode(array('success' => 1, 'message' => 'You have successfully sent a message to ' .
            ...
            $params["subject"] = $message_data["header"];
