...
class Emails extends Secure_area implements iData_controller {
    ...
    function set_dt_templates($datatable)
    {
        ...
        $datatable->add_column('template_subject', false);
    ...
    function _dt_templates()
    {
        ...
        foreach ($emails->result() as $email)
        {
            ...
            $data_row["template_subject"] = $email->template_subject;
    ...
    function delete()
    {
        ...
        {
            send(array('success' => true, 'message' => 'Email Templates have been successfully deleted '));
        }
        else
        {
            send(array('success' => false, 'message' => 'Email Templates cannot be deleted'));
        }
    }
