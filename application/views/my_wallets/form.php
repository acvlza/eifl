<?php echo form_open('my_wallets/save/' . ($wallet_info->wallet_id>0?$wallet_info->wallet_id:-1), array('id' => 'wallet_form')); ?>
...
<div class="modal-body">
    ...
    <div style="overflow-y: auto" id="div-form">
        ...
        <div class="form-group">
            <label>Name</label>
            <input type="text" class="form-control" value="<?=$wallet_info->name;?>" name="wallet_name" id="wallet_name"/>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="input-group date">
                ...
                <input type="text" class="form-control" autocomplete="nope" name="trans_date" id="trans_date" value="<?=($wallet_info->trans_date != '') ? date($this->config->item('date_format'), $wallet_info->trans_date) : date($this->config->item('date_format'));?>" />
            </div>
        </div>
    ...
    $(document).ready(function (){
        ...
        $('#wallet_form').validate({
            submitHandler: function (form) {
                ...
                if ($("#wallet_type").val() === "debit" || $("#wallet_type").val() === "transfer")
                {
