...
<div class="title-block">
    <h3 class="title"> 
        ...
        <?=ktranslate2("Company Settings")?>

    </h3>
    <p class="title-description">
        <?=ktranslate2("Setup company information")?>
    </p>
</div>
            ...
            <div class="card">
                                ...
                                <div class="inqbox-content">
                                    ...
                                    <div class="tabs-container">
                                        ...
                                        <ul class="nav nav-tabs nav-tabs-bordered">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-toggle="tab" href="#tab-info"><?= ktranslate2("Company Information");?></a>
                                            </li>
                                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab-smtp"><?= ktranslate2("SMTP Setup");?></a></li>
                                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab-system"><?= ktranslate2("System");?></a></li>
                                            
                                            <?php if (is_plugin_active("klanguage")): ?>
                                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab-language"><?= ktranslate2("Language");?></a></li>
                                            <?php endif; ?>

                                            <!-- Currency Formatter plugin -->
                                            <?php if (is_plugin_active('currency_formatter')): ?>
                                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab-currency-formatter"><?= ktranslate2("Currency Formatter");?></a></li>
                                            <?php endif;?>
                                            <!-- Currency Formatter plugin -->
                                            
                                            <!-- Currency Holidays plugin -->
                                            <?php if (is_plugin_active('holidays')) : ?>
                                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab-holidays"><?= ktranslate2("Holidays");?></a></li>
                                            <?php endif; ?>
                                        ...
                                        <div class="tab-content">
                                            <div id="tab-info" class="tab-pane fade in active show">
                                                ...
                                                <div class="form-group row"><label class="col-sm-2 control-label"><?php echo form_label($this->lang->line('config_logo') . ':', 'logo', array('class' => 'wide')); ?></label>
                                                    <div class="col-sm-10">
                                                        ...
                                                        <div id="container">
                                                            <a id="browsefile" href="javascript:;" class="btn btn-default"><?= ktranslate2("Browse");?></a> 
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="tab-system" class="tab-pane fade in">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-sm-2 control-label"><?= ktranslate2("Brand URL");?></label>
                                                    <div class="col-lg-10">
                                                    <input type="text" class="form-control" id="app_brand_url" name="app_brand_url" value="<?=$this->config->item("app_brand_url");?>" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 control-label"><?= ktranslate2("Brand Name");?></label>
                                                    <div class="col-lg-10">
                ...
                <div class="form-group">
                    <div class="col-sm-4 col-sm-offset-2">
                        ...
                        <button type="button" class="btn btn-primary" id="btn-save-lang" style="display:none;">Save Translation</button>
                    </div>
                </div>
