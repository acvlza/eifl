...
<link rel="stylesheet" href="<?php echo base_url('js/drag-drop-upload/jquery-simple-upload.css') ?>">
<script src="<?php echo base_url('js/drag-drop-upload/jquery-simple-upload.js') ?>"></script>
...
<div class="title-block">
    <h3 class="title"> 
        ...
        <?= ktranslate2("Plugins - Install")?>

    </h3>
    <p class="title-description">
        <?= ktranslate2("Install & un-install plugins")?>
    </p>
</div>
                                ...
                                <div class="inqbox-content">
                                    ...
                                    <table class="table table-bordered" id="plugin_manager">
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th><?= ktranslate2("Name")?></th>
                                                <th><?= ktranslate2("Description")?></th>
                                                <th><?= ktranslate2("Status")?></th>                            
                                            </tr>
                                        </thead>        
                                    </table>
...
<script>
    $(document).ready(function () {
        ...
        $(document).on("click", ".btn-activate", function () {
            var $this = $(this);
            alertify.confirm("<?= ktranslate2("Are you sure you wish to Activate this plugin")?>?", function () {
        ...
        $(document).on("click", ".btn-uninstall-plugin", function () {
            var $this = $(this);
            alertify.confirm("<?= ktranslate2("Are you sure you wish to uninstall this plugin")?>?", function () {
        ...
        $("#plugin_manager_wrapper .dt-buttons.btn-group").html("<div><button class='btn btn-primary pull-left' id='btn-browse-plugin'><?= ktranslate2("Browse")?></button> &nbsp;<div class='pull-left' style='margin-left: 5px;' id='basic_progress'></div><div id='basic_message' style='margin-left:5px;'></div></div>");
